...
export default function StatuteScreen() {
  return (
    <Content>
      <ContentTitle>Vedtægter</ContentTitle>
      ...
      <p>
        ...
        <a href="mailto:flug-announce@flug.dk">flug-announce(at)flug.dk</a>.
      </p>
      <h3>§3. stk. 3</h3>
      <p>
      ...
      <p>
        ...
        på mailing listen{" "}
        <a href="mailto:flug-stem@flug.dk">flug-stem(at)flug.dk</a> (Se §10).
      </p>
      <h3>§4. stk. 2</h3>
      <p>
      ...
      <p>
        ...
        <a href="mailto:flug-stem@flug.dk">flug-stem(at)flug.dk</a>.
      </p>
      <h3>§10. stk 1</h3>
      <p>
      ...
      <p>
        ...
        adressen <a href="mailto:flug-stem@flug.dk">flug-stem(at)flug.dk</a>. I
        kroppen af denne mail skriver han hvad han stemmer, samt et alias som
        kun han kender.
        <br />
        Ved afslutning af afstemningen sendes svaret på{" "}
        <a href="mailto:flug-announce@flug.dk">flug-announce(at)flug.dk</a>,
        samt en liste over hvem der har stemt (dvs folks rigtige email
        adresser), samt en liste over hvad hvilke aliases har stemt.
      </p>
    </Content>
  );
}
