  ...
  return (
    <ContentAlignment>
      ...
      <div id="admin-container">
        <InternalLink target="/admin/events" title={text("event.events")}>
          <EventIcon />
          {text("event.events")}
        </InternalLink>
        <InternalLink target="/admin/blogs" title={text("blog.blogs")}>
          <BlogIcon />
          {text("blog.blogs")}
        </InternalLink>
        <InternalLink target="/admin/users" title={text("user.users")}>
          <UsersIcon />
          {text("user.users")}
        </InternalLink>
      </div>
